 ...
 */
@ApiModel(value="新增目录请求封装类" ,description="")
public class AddRequestBean implements Serializable {
	...
	@ApiModelProperty(name="catelogId",value="分类id",notes="选填",required=false,dataType="String")
	private String  catelogId; //分类id
	
	@ApiModelProperty(name="pkSum",value="打包费",required=true,dataType="Double")
	private Double pkSum;   //打包费
	
	@ApiModelProperty(name="name",value="分类名称",required=true,dataType="String")
	private String name;   //分类名称
	
	@ApiModelProperty(name="sort",value="排序号",required=true,dataType="Integer")
