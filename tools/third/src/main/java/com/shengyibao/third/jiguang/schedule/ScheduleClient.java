package com.shengyibao.third.jiguang.schedule;
...
public class ScheduleClient {
	...
	public ScheduleResult createSchedule(SchedulePayload payload)
	...
	public ScheduleResult getSchedule(String scheduleId)
		...
		Preconditions.checkArgument(
				StringUtils.isNotEmpty(scheduleId), "scheduleId should not be empty");
	...
	public ScheduleResult updateSchedule(String scheduleId, SchedulePayload payload)
		...
		ResponseWrapper response =
				_httpClient.sendPut(hostName + schedulePath + "/" + scheduleId, payload.toString());
		return ScheduleResult.fromResponse(response, ScheduleResult.class);
	}
