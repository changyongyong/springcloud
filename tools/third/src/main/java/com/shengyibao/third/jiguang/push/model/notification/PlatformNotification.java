...
import com.shengyibao.third.jiguang.push.model.PushModel;
...
public abstract class PlatformNotification implements PushModel {
	...
	private static final Logger logger = LoggerFactory.getLogger(PlatformNotification.class);
	...
	public PlatformNotification(
			Object alert, Map<String, String> extras, Map<String, Number> numberExtras,
	...
	protected abstract static class Builder<T extends PlatformNotification, B extends Builder<T, B>> {
		...
		public B addExtra(String key, String value) {
			...
			if (null == value) {
				logger.debug("Extra value is null, throw away it.");
				return theBuilder;
			}
		...
		public B addExtras(Map<String, String> extras) {
			if (null == extras) {
				logger.warn("Null extras param. Throw away it.");
				return theBuilder;
			}
