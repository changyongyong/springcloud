...
public class IosNotification extends PlatformNotification {
	...
	private static final Logger logger = LoggerFactory.getLogger(IosNotification.class);
	...
	private static final String ALERT_VALID_BADGE =
			"Badge number should be 0~99999, " + "and can be prefixed with + to add, - to minus";
	...
	private IosNotification(
			Object alert, String sound, String badge, boolean contentAvailable,
			boolean soundDisabled, boolean badgeDisabled, String category, boolean mutableContent,
			Map<String, String> extras, Map<String, Number> numberExtras,
	...
	public static class Builder extends PlatformNotification.Builder<IosNotification, Builder> {
		...
		public IosNotification build() {
			return new IosNotification(
					alert, sound, badge, contentAvailable, soundDisabled, badgeDisabled, category,
					mutableContent, extrasBuilder, numberExtrasBuilder, booleanExtrasBuilder,
					jsonExtrasBuilder);
		}
	}
}
