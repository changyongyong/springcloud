...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static SimpleDateFormat sdfDateTime =
			new SimpleDateFormat(DateUtils.DATE_FORMAT_DATETIME);
	// Global SimpleDateFormat object
	public static SimpleDateFormat sdfDateOnly =
			new SimpleDateFormat(DateUtils.DATE_FORMAT_DATEONLY);
	...
	public static java.sql.Timestamp toSqlTimestamp(String sDate) {
		...
		return toSqlTimestamp(
				sDate, sDate.length() == DateUtils.DATE_FORMAT_DATEONLY.length()
	...
	public static String getSysDateTimeStringForTZ() {
		return toString(
	 ...
	 */
	public static
			boolean isBetween(Date date, Date start, Date end, int interModel, int compModel) {
	 ...
	 */
	public static
			boolean isOverIntervalLimit(Date startDate, Date endDate, int interval, int dateUnit) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(new Date());
	 ...
	 */
	public static
			boolean isOverIntervalLimit(String startDateStr, String endDateStr, int interval) {
		Date startDate = null;
		Date endDate = null;
		try {
	...
	/**
	 * 
	 *功 能：Java将Unix时间戳转换成指定格式日期字符串 <br />
	 *
	 *<br />----------------------------------------------------------------<br />
	 *修改记录 ：<br />
	 *日 期  版本 修改人 修改内容<br />
	 *2017年4月18日 v0.0.1 changyy 创建<br />
	 *<br />----------------------------------------------------------------
	...
	public static void main(String[] args) throws ParseException {
		System.out.println(getSysDateTimeStringForTZ());
	}
}
