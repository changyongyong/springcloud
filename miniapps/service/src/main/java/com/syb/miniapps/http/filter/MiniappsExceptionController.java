package com.syb.miniapps.http.filter;
...
@ControllerAdvice
public class MiniappsExceptionController {

	private static final Logger logger = LogManager.getLogger(MiniappsExceptionController.class);
