package com.ddxxsyb.stock.http.interceptor;
...
public class ServiceStockInterceptor implements HandlerInterceptor {

	private static final Logger logger = LoggerFactory.getLogger(ServiceStockInterceptor.class);
