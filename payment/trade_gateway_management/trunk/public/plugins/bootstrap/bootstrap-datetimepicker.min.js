!function (c) {
    ...
    var e = function (i, h) {
        ...
        this.icons = {leftArrow: this.fontAwesome ? "fa-arrow-left" : (this.bootcssVer === 3 ? "glyphicon-arrow-left" : "glyphicon glyphicon-arrow-left"), rightArrow: this.fontAwesome ? "fa-arrow-right" : (this.bootcssVer === 3 ? "glyphicon-arrow-right" : "glyphicon glyphicon-arrow-right")};
