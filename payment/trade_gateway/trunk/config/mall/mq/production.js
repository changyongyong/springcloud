...
module.exports = {
    ...
    exchange: [{
        ...
        mq: outMq,
        options: {
            exchange: 'mall.tradeGateway.paymentResult'
        }
    }, {
        //对其它系统发送退款结果
        ...
        mq: outMq,
        options: {
            exchange: 'mall.tradeGateway.refundResult'
        }
    }, {
        //对其它系统发送转账结果
        ...
        mq: outMq,
        options: {
            exchange: 'mall.tradeGateway.transferResult',
        }
    },{
        //对其它系统发送转账结果
        ...
        mq: outMq,
        options: {
            exchange: 'mall.tradeGateway.accountResult',
        }
    }]
};